...
Hadoop emerged as the strongest tool to deal with the above challenges of the big
...
legacy systems, all the available data and inputs were not used to do the analysis 
