...
The following Figure 1 displays the vanilla hadoop deployment.

\begin{center}
\includegraphics[scale=0.35]{images/vanilla.png}\label{s:vani_archi}
\end{center}
\textbf{Figure 1: Vanilla Hadoop Architecture
~\cite{hid-sp18-412-hadoop-architecture-overview}} 
...
The following Figure 2 displays the HDFS Architecture.

\begin{center}
\includegraphics[scale=0.35]{images/HDFSarchi.png}\label{s:hdfs}
\end{center}
\textbf{Figure 2: HDFS Architecture~\cite{hid-sp18-412-HDFS-Architecture}} 
...
The structuring of the secondary NameNode is shown in the Figure 3.

\begin{center}
\includegraphics[scale=0.35]{images/StructureOfSecondaryNode.png}\label{s:hdfs}
\end{center}
\textbf{Figure 3: Structuring of the Secondary NameNode
~\cite{hid-sp18-412-hadoop-architecture-overview}}


The Figure 3 shows the structuring of the secondary NameNode. 
...
The following Figure 4 the perfect example of the MapReduce 
job with respect to the 
WordCount application~\cite{hid-sp18-412-hadoop-architecture-overview}.

\begin{center}
\includegraphics[scale=0.35]{images/WordCountMapReduce.png}\label{s:hdfs}
\end{center}
\textbf{Figure 4: Word Count MapReduce 
Job~\cite{hid-sp18-412-hadoop-architecture-overview}} 
...
The following figure 5 describes the architecture of the YARN.

\begin{center}
\includegraphics[scale=0.35]{images/YARNArchitecture.png}\label{s:hdfs}
\end{center}
\textbf{Figure 5: Architecture of YARN~\cite{hid-sp18-412-YARN_Architecture}} 
...
The following figure 6 describes the architecture of the Resource Manager.

\begin{center}
\includegraphics[scale=0.35]{images/YARNResourceManager.png}\label{s:res}
\end{center}
\textbf{Figure 6: Architecture of 
Resource Manager~\cite{hid-sp18-412-ResourceManager_Architecture}}
...
The following figure 7 displays the division of 
the Node Manager into containers.
\begin{center}
\includegraphics[scale=0.35]{images/nodemanager.png}\label{s:res}
\end{center}
\textbf{Figure 7: Node Manager~\cite{hid-sp18-412-YARN_Hadoop_Internal}}
...
The following figure 8 displays the division 
of the Node Manager into containers.
\begin{center}
\includegraphics[scale=0.35]{images/RaspberryPiSpark.png}\label{s:rasp}
\end{center}
\textbf{Figure 8: Hadoop Architecture deployed on Rasberry Pi 3}
...
The following figure 9 describes the implementation of the 
docker-spark architecture that is deployed on the Ubuntu 17.10.
\begin{center}
\includegraphics[scale=0.35]{images/dockerspark.png}\label{s:dockerspark}
\end{center}
\textbf{Figure 9: Architecture of Docker-Spark Deployment}
...
Spark offers great features in terms of speed, simplicity and high level support
 ...
 responsible for their code in the software code release.
...
progress and status of the work carried out by the respective workers.
...
Cassandra, Apache Hadoop, Apache Hbase and Apache Hive.
...
efficiently on top of Spark core.
...
data scientists and statisticians to use their language R in a mechanism that is
 light weight used for calling upon spark’s capability.
...
Once we load the data into RDD, two basic types of operations are carried out.
...
applications tend to spend maximum time in reading and writing tasks in HDFS.
...
data and serialization that in turn degrades the system performance. 
\begin{center}

% \begin{figure}[htb!]
        \centering\includegraphics[scale=0.35]
        {images/iterative-MapReduce.png}
        \label{fig:iterative-MapRed}
% \end{figure}

\end{center}
\textbf{Iterative Operations on MapReduce}
...
of interactive queries on MapReduce.
...
% \begin{figure}[htb!]
        \centering\includegraphics[scale=0.35]
        {images/interactive-MapReduce.png}
        \label{fig:interactive-MapRed}
% \end{figure}

\end{center}
\textbf{Interactive Operations on MapReduce}
...
results then Spark stores those results on disk.

\begin{center}

% \begin{figure}[htb!]
        \centering\includegraphics[scale=0.35]
        {images/iterativeSpark.png}
        \label{fig:iterative-spark}
% \end{figure}

\end{center}
\textbf{Iterative Operations on Spark RDD}
...
% \begin{figure}[htb!]
        \centering\includegraphics[scale=0.35]
        {images/interactiveSpark.png}
        \label{fig:interactive-spark}
% \end{figure}

\end{center}
\textbf{Interactive Operations on Spark RDD}
